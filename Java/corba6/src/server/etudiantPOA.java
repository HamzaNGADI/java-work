...
public abstract class etudiantPOA extends org.omg.PortableServer.Servant
 implements server.etudiantOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // server/etudiant/_get_nom
       {
         String $result = null;
         $result = this.nom ();
         out = $rh.createReply();
       ...
       case 1:  // server/etudiant/_get_prenom
       {
         String $result = null;
         $result = this.prenom ();
         out = $rh.createReply();
