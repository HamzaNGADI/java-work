...
public class DicoBinarbre implements Dictionnaire {
	...
	public Dictionnaire addWords(String... words) {
		...
		{
			binarbre=binarbre.addVal(words[i]); 
			i++;
		}
	...
	private static Liste<String> commonPrefixRec(String prefix, Binarbre<String> sousarbre) {
        ...
        {
        	return commonPrefixRec(prefix,sousarbre.getLeft()).add(sousarbre.getVal()).addAll(commonPrefixRec(prefix,sousarbre.getRight()));
        }
        ...
        {
        	return commonPrefixRec(prefix,sousarbre.getLeft());
        }
