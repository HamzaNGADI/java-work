...
public class _gestionabonnesStub extends org.omg.CORBA.portable.ObjectImpl implements server.gestionabonnes
{
  ...
  public void creation_abonne (int numero, String nom, String prenom, server.abonneHolder ref) throws server.dejaExistant
  {
            ...
            try {
                ...
                creation_abonne (numero, nom, prenom, ref        );
            } finally {
                _releaseReply ($in);
            }
  } // creation_abonne
