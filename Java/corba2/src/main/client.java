...
public class client {
	...
	public static void main(String[] args) {
        ...
        try
         {
        	System.out.println("init memoire : "+calc.memoire());
        	calc.ajouteMemoire(10);
        	System.out.println("memoire : "+calc.memoire());
        	calc.soustraitMemoire(5);
        	System.out.println("memoire : "+calc.memoire());
        	calc.multiplieMemoire(15);
        	
        	System.out.println("fin memoire : "+calc.memoire());
